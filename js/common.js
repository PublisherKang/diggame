...
let vipTimeInterval = null;
let boostTimeInterval = null;
...
//                gemScore[i].textContent = score;
//            }
//            document.querySelector(".target_img").parentNode.querySelector(".now_durability").textContent = itemInfo.CurrentDurability;
//            document.querySelectorAll(".upgrade_wrap .durability span")[0].textContent = itemInfo.CurrentDurability;
//        }
//        //구매 실패 했을 때
//        else {
//            repairPop.style.display = "none";
...
//        invenItemUl.insertAdjacentHTML("beforeend", getItemListHtml(invenMineItemList[i], itemImage));
//    };
...
//    for (let i = 0; i < invenMineItemList.length; i++) {
//        let itemImage = getItemImage(invenMineItemList[i]);
//        tradeInvenItemUl.insertAdjacentHTML("beforeend", getItemListHtml(invenMineItemList[i], itemImage));
//    };
